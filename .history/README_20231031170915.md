...
### Pre-requisite:
All following commands are executed in the same directory as main.go, which is "cmd/tftp". Assume tftp installed. We will use it as client. I have a Mac so it's already installed.
