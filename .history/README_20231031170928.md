...
### Pre-requisite:
All build and testing commands are executed in the same directory as main.go, which is "cmd/tftp". Assume tftp is installed. We will use it as client. I have a Mac so it's already installed.
