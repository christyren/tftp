...
### Pre-requisite:
All following commands are executed in the same directory as main.go, which is "cmd/tftp". Assume you already have tftp installed. I have a Mac so it's already installed.
